...
struct node_traits {
	...
	using reference = typename Node::value_type;
...
concept input_iterator_of_pair = input_iterator_type<Iter>&& std::is_same_v<std::pair<K, V>, typename std::iterator_traits<Iter>::value_type>;
